        ...
        <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td rowspan="<?php echo e($data['totalRows']+1); ?>" >
                    <input class="form-check-input mainCheck" id="name_<?php echo e($data['copy']['id']); ?>" idbd="<?php echo e($data['copy']['id']); ?>" url='<?php echo e($data['copy']['fileName']); ?>' type="checkbox" checked>
                    <label class="form-check-label" for="name_<?php echo e($data['copy']['id']); ?>" style="width: 400px;word-break: break-all;">
                        <a href="<?php echo e($data['copy']['fileName']); ?>" target="_blank"><?php echo e($data['copy']['fileName']); ?></a>
                    </label>
                </td>
            </tr>
...
generateRaportMini.addEventListener("click", function(){
    window.location.replace('<?php echo e(route("pdf-mini-g",$id)); ?>');
})
let generateRaportBig = document.querySelector('.raportBig')
generateRaportBig.addEventListener("click", function(){
    window.location.replace('<?php echo e(route("pdf-max-g",$id)); ?>');
})
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programs\OS\OSPanel\domains\PLAGIATUS\resources\views/raportGoogle.blade.php ENDPATH**/ ?>