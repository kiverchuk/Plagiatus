        ...
        @foreach ($dates as $key => $data)
            <tr>
                ...
                <td rowspan="{{$data['totalRows']+1}}" >
                    <input class="form-check-input mainCheck" id="name_{{$data['copy']['id']}}" idbd="{{$data['copy']['id']}}" type="checkbox" checked>
                    <label class="form-check-label" for="name_{{$data['copy']['id']}}">
                        {{$data['copy']['fileName']}}
                    </label>
                </td>
            </tr>
